...
public class Movement : MonoBehaviourPunCallbacks, IPunObservable
{
    ...
    // OnPhotonSerializeView로 동기화하기 (PhotonTransformView Component 제거 후)
    // 수신된 위치와 회전값을 저장할 변수
    ...
    void Update()
    {
        ...
        else // OnPhotonSerializeView로 동기화하기, Component로 동기화할 때는 필요 없음.
        {
            // 수신된 좌표로 보간한 이동 처리
    ...
    // OnPhotonSerializeView로 동기화하기, Component로 동기화할 때는 필요 없음.
